...
export default class GenVCalculation {
    constructor(props) {
        ...
        if (this.ballName === 'master-ball') {
            ...
            this.probability = calculateGenVCaptureProbability(this.props.captureRate, this.props.ballSettings[1].settings['generation-v'], this.props.pokemonHpStat, this.props.pokemonLevel, this.props.hp, this.props.statusAilment, this);
        }
