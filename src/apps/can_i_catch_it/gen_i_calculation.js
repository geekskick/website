    ...
    getExplaination() {
        if (this.ballName !== 'master-ball') {
            return (<Box>
                ...
                <BlockMath math={String.raw`{\color{orange}f} \approx \left\lfloor \frac{{\color{gold}\text{HP}_{\text{max}}} \times 255 \times 4}{\text{HP}_{\text{current}} \times {\color{red}\text{ball}}} \right\rfloor \approx \left\lfloor \frac{{\color{gold}${this.pokemonHpMax}} \times 255 \times 4}{${this.pokemonHpCurrent.toFixed(2)} \times {\color{red}${this.ballMod}}} \right\rfloor \approx ${this.f.toFixed(2)}`} />
                <BlockMath math={String.raw`{\color{red}p_{1}} = \frac{\text{catchRate} + 1}{{\color{fuchsia}\text{ballMod}} + 1} \times \frac{{\color{orange}f} + 1}{256} = \frac{${this.props.captureRate} + 1}{{\color{fuchsia}${this.ballMod}} + 1} \times \frac{{\color{orange}${this.f.toFixed(2)}} + 1}{256} = ${this.p1.toFixed(2)}`} />
